...
#ifndef NUDGE_SWIFT_H
#define NUDGE_SWIFT_H
...
+ (BOOL)registerForPushNotificationsAndReturnError:(NSError * _Nullable * _Nullable)error;
+ (void)onRegisteredForNotificationsWithDeviceToken:(NSData * _Nonnull)deviceToken;
